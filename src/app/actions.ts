...
const DEFAULT_CONTENT: Record<string, any> = {
  home: {
    ...
    platforms: 'Bugcrowd,Researcher,#f37023,https://bugcrowd.com/h/jaishanth; TryHackMe,Top 1%,#88cc14,https://tryhackme.com/p/jaishanth; LinkedIn,Jaishanth,#0077b5,https://linkedin.com/in/jaishanth; GitHub,jaishanthm,#333,https://github.com/jaishanthm; Discord,jaishanthm,#5865F2,https://discord.com/users/jaishanthm',
...
export async function getSocialLinks() {
  try {
    ...
    if (docs.length === 0) {
      const defaults = [
        { platform: 'Bugcrowd', url: 'https://bugcrowd.com/h/jaishanth', icon: '🐞', order: 1, enabled: true },
        { platform: 'LinkedIn', url: 'https://linkedin.com/in/jaishanth', icon: '🔗', order: 2, enabled: true },
