        ...
        {selected && (
          ...
          >
            <motion.div
              ...
              className="bg-dark-panel border border-neon-purple/50 rounded-2xl max-w-3xl w-full text-center shadow-[0_0_50px_rgba(157,0,255,0.3)] relative max-h-[90vh] overflow-y-auto my-auto"
            >
              ...
              <div className="p-4 sm:p-6 pt-10 sm:pt-8">
                <h2 className="font-display text-xl sm:text-2xl font-bold text-white mb-2 pr-6">{selected.title}</h2>
                <p className="font-mono text-gray-400 mb-5 flex flex-wrap justify-center items-center gap-2 sm:gap-4 text-xs sm:text-sm">
                ...
                {selected.verifyUrl && (
                  <a href={selected.verifyUrl} target="_blank" rel="noopener noreferrer" className="neon-btn inline-block w-full sm:w-auto text-sm py-2.5">
