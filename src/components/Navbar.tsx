        ...
        <div className="flex items-center gap-3">
          ...
          >
            <img
              ...
              className="rounded-full relative object-cover w-full h-full border border-white/20 group-hover:scale-105 transition-transform duration-300 shadow-[0_0_10px_rgba(157,0,255,0.6)]"
            />
          </button>
